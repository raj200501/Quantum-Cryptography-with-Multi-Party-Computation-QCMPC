# 🌟 Quantum Cryptography with Multi-Party Computation (QCMPC) 🌟
...
```
Generated key (pre-error-correction): 0001011110010001
Encrypting message: Hello, Quantum World!
Decrypting message: ...
Running SMPC simulation...
Secure Addition Result: 12 15 18
Secure Multiplication Result: 28 80 162
```

### One-Command Verification

For a full run + smoke test:
...
- **`g++: command not found`**
  Install a C++17-compatible compiler (e.g., `g++` on Linux or Xcode Command Line Tools on macOS).
